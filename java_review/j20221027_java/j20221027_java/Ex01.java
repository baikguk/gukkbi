...
public class Ex01 {
  public static void main(String[] args){
    ...
    // compareTo()
    // 각 상수들의 index 값의 차를 반환하므로
    //   ㄴ ordinal() 메소드의 반환값
    // d1.compareTo(d2) : EAST(0), SOUTH(1), WEST(2), NORTH(3)
    // d1.compareTo(d2) : EAST - WEST 는 -2 가 되고
    // d1.compareTo(d2) : EAST - SOUTH 는 -1 이 됨
    ...
    // enum Direction {EAST, SOUTH, WEST, NORTH}
    Direction[] arrDirect = Direction.values();
    for(Direction d : arrDirect){
